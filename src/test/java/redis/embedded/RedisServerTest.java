...
public class RedisServerTest {
    ...
    public void shouldOverrideDefaultExecutable() throws Exception {
        RedisExecProvider customProvider = RedisExecProvider.defaultProvider()
                .override(OS.UNIX, Architecture.x86, Resources.getResource("Redis2/redis-server-32").getFile())
                .override(OS.UNIX, Architecture.x86_64, Resources.getResource("Redis2/redis-server").getFile())
                .override(OS.WINDOWS, Architecture.x86, Resources.getResource("Redis2/redis-server.exe").getFile())
                .override(OS.WINDOWS, Architecture.x86_64, Resources.getResource("Redis2/redis-server.exe").getFile())
                .override(OS.MAC_OS_X, Resources.getResource("Redis2/redis-server").getFile());
